...
import { responsesList } from 'dashboard/components-next/ai_agent/pageComponents/emptyStates/ai_agentEmptyStateContent.js';
...
<template>
  <FeatureSpotlight
    ...
    fallback-thumbnail="/assets/images/dashboard/ai_agent/faqs-light.svg"
    fallback-thumbnail-dark="/assets/images/dashboard/ai_agent/faqs-dark.svg"
